...
class EntityFactory:
    ...
    def get_entity(entity_name: str):
        match entity_name:
            ...
            case 'Level3Bg':
                list_bg = []
                for i in range(5):  # level3bg images number (ajuste conforme a quantidade de imagens para o Level 3)
            ...
            case 'Enemy3':
                # Enemy3 será posicionado aleatoriamente no eixo y e fora do lado direito da tela
